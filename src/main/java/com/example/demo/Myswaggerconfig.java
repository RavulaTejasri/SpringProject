...
public class Myswaggerconfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("TCS Fullstack Team").description("API reference guide EmployeeController").termsOfServiceUrl("https://www.tcs.com/").contact("TCS user").version("1.0").build();	
	}
}